...
1. [**Basados en costes**](#metodos-basados-en-los-costes-o-de-precios-internos)
    - Precio límite
    - Precio técnico
    - Precio objetivo
2. [**Basados en la competencia**](#metodos-basados-en-la-competencia)
...
1. **Pago en efectivo o pronto pago:** sirve para incrementar la liquidez y reducir los costes relacionados con el crédito.
2. **Cantidad:** rappels, sirve para ahorrar en existencias y transporte; y asegurar ventas.
3. **Funcionales:** se ofrecen a miembros del canal para que lleven a cabo funciones como el almacenamiento o mantenimiento de la actividad.
4. **Estacionales:** descuentos a aquellos que compran mercancías fuera de la temoporada alta → ayuda a mantener la actividad.
5. **Otros:** incentivos y reducciones. *Ej: entregar un producto viejo por la compra de uno nuevo*

!!! example "Descuento por pronto pago"
    ![img](../images/tema-2/ejemplo-descuento-pronto-pago.png)
...
- **Para prestaciones opcionales:** se puede adquirir el producto básico o adquirir elementos que enriquecen el producto (`DLCs`).
- **Para productos cautivos:** precio de productos complementarios o auxiliaries (*cápsula de café*).
